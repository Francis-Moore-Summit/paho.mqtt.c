...
typedef union
{
	...
	struct
	{
        ...
        uibool dup : 1;			/**< DUP flag bit */
		unsigned int qos : 2;	/**< QoS value, 0, 1 or 2 */
        uibool retain : 1;		/**< retained flag bit */
	} bits;
#else
	struct
	{
...
typedef struct
{
	...
	union
	{
		...
		struct
		{
            uibool username : 1;			/**< 3.1 user name */
            uibool password : 1; 			/**< 3.1 password */
            uibool willRetain : 1;		/**< will retain setting */
			unsigned int willQoS : 2;	/**< will QoS value */
            uibool will : 1;			/**< will flag */
            uibool cleanstart : 1;	/**< cleansession flag */
			int : 1;	/**< unused */
		} bits;
#else
		struct
...
typedef struct
{
	...
	union
	{
		...
		struct
		{
            ...
            uibool sessionPresent : 1;    /**< was a session found on the server? */
		} bits;
#else
		struct
		{
